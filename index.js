...
import GoogleLanguage from "./services/GoogleLanguage.js";

import { SCALES, USER_ID } from "./utils/constants.js";
...
async function main() {
  try {
    ...
    const stream = twitter.stream("statuses/filter", { follow: [USER_ID] });
